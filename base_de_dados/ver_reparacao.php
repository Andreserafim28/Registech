...
<div class="content" style="max-width:900px; margin:auto; padding-top:60px; padding-bottom: 60px;">
    ...
    <div class="table-container">
        ...
        <div style="margin-top: 40px; display: flex; gap: 15px;">
            <a href="../reparacoes.php" class="btn-add" style="text-decoration: none; background: #333; display: inline-flex; align-items: center; gap: 10px; padding: 12px 25px; border-radius: 8px; color: white; font-weight: bold;">
                <i class="fas fa-arrow-left"></i> Voltar
            </a>
            <a href="editar_reparacao.php?id=<?php echo $row['id_reparacao']; ?>" class="btn-add" style="text-decoration: none; background: linear-gradient(135deg, #7b2cbf 0%, #9d4edd 100%); display: inline-flex; align-items: center; gap: 10px; padding: 12px 25px; border-radius: 8px; color: white; font-weight: bold; border: none; cursor: pointer;">
